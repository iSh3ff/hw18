sequence_1 = str(input("Введите последовательность чисел через пробел: "))
number_1 = int(input("Введите число, чтобы узнать его (или ближайшего) индекс в списке: "))
...
print('\n', 'Список сортированный по возрастанию: ', sequence_4, '\n')
if sequence_5:
